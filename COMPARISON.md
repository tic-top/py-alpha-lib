...
`alpha.SUMIF` 的 Rust FFI 签名要求 `condition` 参数为 `bool` 数组，但 Python wrapper 和 ExecContext 均误将其转为 `float64`，导致 #144、#190 运行时报错 `invalid input (expected float, float, bool)`。

修复：`algo_gen.py` 和 `context.py` 中将 `condition` 转为 `np.asarray(cond, dtype=bool)`。
...
| #054 | `STD(CLOSE)` 缺少窗口参数，原文歧义 |
| #127 | `MEAN(CLOSE)` 缺少窗口参数 + `MAX(CLOSE,12)` 歧义 |
| #143 | 使用递归 `SELF` 引用，与向量化计算不兼容 |
| #165 | `SUMAC(CLOSE)` 缺少窗口参数 |
| #181 | `SUM(((CLOSE/DELAY(CLOSE,1)-1)-MEAN(...))^2)` 缺少窗口参数 |
| #183 | `SUMAC(CLOSE,48)/48` 窗口参数不确定 |
...
|---|---|---|---|---|---|---|---|
| #001 | 36ms | | #065 | 6ms | | #131 | 22ms |
| #002 | 15ms | | #066 | 11ms | | #132 | 5ms |
| #003 | 26ms | | #067 | 13ms | | #133 | 14ms |
| #004 | 33ms | | #068 | 14ms | | #134 | 9ms |
| #005 | 19ms | | #069 | 24ms | | #135 | 6ms |
| #006 | 24ms | | #070 | 1ms | | #136 | 10ms |
| #007 | 21ms | | #071 | 9ms | | #137 | 143ms |
| #008 | 24ms | | #072 | 12ms | | #138 | 55ms |
| #009 | 15ms | | #073 | 17ms | | #139 | 3ms |
| #010 | 16ms | | #074 | 31ms | | #140 | 63ms |
| #011 | 14ms | | #075 | 8ms | | #141 | 20ms |
| #012 | 24ms | | #076 | 15ms | | #142 | 44ms |
| #013 | 10ms | | #077 | 30ms | | #144 | 13ms |
| #014 | 3ms | | #078 | 19ms | | #145 | 9ms |
| #015 | 3ms | | #079 | 20ms | | #146 | 86ms |
| #016 | 24ms | | #080 | 7ms | | #147 | 4ms |
| #017 | 16ms | | #081 | 0ms | | #148 | 27ms |
| #018 | 4ms | | #082 | 13ms | | #149 | 20ms |
| #019 | 21ms | | #083 | 20ms | | #150 | 7ms |
| #020 | 8ms | | #084 | 15ms | | #151 | 7ms |
| #021 | 4ms | | #085 | 27ms | | #152 | 15ms |
| #022 | 18ms | | #086 | 28ms | | #153 | 7ms |
| #023 | 37ms | | #087 | 33ms | | #154 | 7ms |
| #024 | 6ms | | #088 | 8ms | | #155 | 9ms |
| #025 | 48ms | | #089 | 13ms | | #156 | 36ms |
| #026 | 11ms | | #090 | 21ms | | #157 | 52ms |
| #027 | 21ms | | #091 | 22ms | | #158 | 13ms |
| #028 | 45ms | | #092 | 34ms | | #159 | 69ms |
| #029 | 8ms | | #093 | 18ms | | #160 | 15ms |
| #031 | 5ms | | #094 | 17ms | | #161 | 21ms |
| #032 | 20ms | | #095 | 4ms | | #162 | 62ms |
| #033 | 25ms | | #096 | 20ms | | #163 | 9ms |
| #034 | 2ms | | #097 | 4ms | | #164 | 27ms |
| #035 | 27ms | | #098 | 51ms | | #166 | 35ms |
| #036 | 24ms | | #099 | 23ms | | #167 | 9ms |
| #037 | 18ms | | #100 | 6ms | | #168 | 4ms |
| #038 | 14ms | | #101 | 38ms | | #169 | 20ms |
| #039 | 37ms | | #102 | 16ms | | #170 | 31ms |
| #040 | 15ms | | #103 | 5ms | | #171 | 19ms |
| #041 | 12ms | | #104 | 15ms | | #172 | 51ms |
| #042 | 10ms | | #105 | 13ms | | #173 | 17ms |
| #043 | 9ms | | #106 | 4ms | | #174 | 16ms |
| #044 | 26ms | | #107 | 42ms | | #175 | 17ms |
| #045 | 22ms | | #108 | 25ms | | #176 | 21ms |
| #046 | 12ms | | #109 | 8ms | | #177 | 5ms |
| #047 | 17ms | | #110 | 18ms | | #178 | 9ms |
| #048 | 27ms | | #111 | 17ms | | #179 | 30ms |
| #049 | 66ms | | #112 | 61ms | | #180 | 31ms |
| #050 | 145ms | | #113 | 29ms | | #182 | 8ms |
| #051 | 68ms | | #114 | 34ms | | #184 | 20ms |
| #052 | 16ms | | #115 | 47ms | | #185 | 9ms |
| #053 | 5ms | | #116 | 6ms | | #186 | 102ms |
| #055 | 145ms | | #117 | 47ms | | #187 | 15ms |
| #056 | 33ms | | #118 | 11ms | | #188 | 13ms |
| #057 | 14ms | | #119 | 39ms | | #189 | 8ms |
| #058 | 6ms | | #120 | 24ms | | #190 | 102ms |
| #059 | 29ms | | #121 | 39ms | | #191 | 6ms |
| #060 | 7ms | | #122 | 23ms | | | |
| #061 | 21ms | | #123 | 29ms | | | |
| #062 | 9ms | | #124 | 14ms | | | |
| #063 | 15ms | | #125 | 29ms | | | |
